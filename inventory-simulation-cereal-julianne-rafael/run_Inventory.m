...
for SampleNum = 1:NumSamples
    FractioBacklogged{SampleNum} = InventorySamples{SampleNum}.fraction_ordersbacklogged();
end
...
DelayTimes = zeros(1, 0); % empty array
